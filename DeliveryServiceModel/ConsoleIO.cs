            ...
            do
            {
                    ...
                    "11. Exit.\n", 1, 11))
                {
                    ...
                    case 6:
                        ...
                        {
                            Id = 25,
                            User = new User { Id = 20, Address = "г. Днепр, ул. Тарасова, д. 7, кв. 9", Name = "Нуров Александр Александрович", Phone = "380783423231" },
                            Products = new List<Product> { new Product
            {
                ...
                CategoryId = Category.KitchenStove
                    ...
                    case 8:
                        ...
                        {
                            Id = 24,
                            User = new User { Id = 15, Address = "г. Новомосковск, ул. Советская, 56б, кв. 16", Name = "Соблев Владимир Николаевич", Phone = "380671827384" },
                            Products = new List<Product> { new Product
            {
                Amount = 12,
                DepthInMeters = 1.1M,
